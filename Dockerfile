...
ENV ANDROID_BUILD_TOOLS_VERSION build-tools-26.0.1,build-tools-25.0.2,build-tools-25.0.0,build-tools-24.0.1,build-tools-24,build-tools-23.0.3,build-tools-23.0.2,build-tools-23.0.1
